...
//    }
    ...
    public ResponseEntity<Object> getStoreLogo(@PathVariable("store_id") String storeId) throws MalformedURLException {
//        URL storeLogo = new URL(storeService.getStoreLogo((storeId)));
        String storeLogo = storeService.getStoreLogo(storeId);
        return ResponseHandler.generateResponse("Successfully retrieve logo", HttpStatus.OK, storeLogo);
    }
    ...
    @PreAuthorize("hasAnyAuthority('SELLER_CREATE', 'BUYER_CREATE')")
    @PostMapping("/stores/{store_id}/upload_profile/profile")
    public ResponseEntity<Object> updateStoreLogo(@PathVariable("store_id") String storeId, @RequestPart("image") MultipartFile file) throws IOException {
        String imagePath = storeService.uploadStoreProfile(storeId, file);
        return ResponseHandler.generateResponse("Successfull to retrive image", HttpStatus.OK, imagePath);
    ...
    @DeleteMapping("/stores/{store_id}/uploaded_profile")
